...
const labelColors: Record<MatchLabel, { bg: string; fg: string }> = {
  ...
  'Good Match': { bg: 'rgba(26,169,201,0.16)', fg: '#1AA9C9' },
...
export default function OpportunityAssessmentCard({ a }: { a: OpportunityAssessment }) {
  ...
  return (
    <div
      style={{
        padding: '1rem',
        background: 'rgba(26, 169, 201, 0.06)',
        borderRadius: '8px',
    ...
    >
      ...
      <Bullets title="Competitive advantages" items={a.competitiveAdvantages} icon={<Award size={14} color="#1AA9C9" />} color="#1AA9C9" />
      ...
      {/* Recommended action */}
      <div style={{ paddingTop: '0.4rem', borderTop: '1px solid rgba(42, 51, 61,0.08)' }}>
